...
export default function SuperTournamentPage() {
  const isAdmin =
              ...
              onSubmit={async (values) => {
                try {
                  ...
                  const req = await fetch(
                    'https://alihan-myproject.azurewebsites.net/api/v1/app/admin/super/tourney',
                    {
                      method: 'POST',
                  ...
                  if (req.ok) {
                    ...
                    AlertMessage(
                      'Maybe you not an admin or somesthing went wrong on server side !(',
                      'error'
                    );
                  }
                } catch (error) {
